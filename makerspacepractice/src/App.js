...
//         { id: 4, name: 'Brown Johnson', studentId: '451124', signInTime: '2024-09-10T10:45:00' },
//         { id: 5, name: 'Mary Wang', studentId: '123456', signInTime: '2024-10-10T10:40:00' }
//       ];
//       setCheckIns(data);
//     };
//     fetchData();
...
//     setSelectedStudentId(id); // 设置选中的签到记录的唯一ID
//   };
...
//           <option value="week">Filter: Last Week</option>
//           <option value="month">Filter: Last Month</option>
//           <option value="month">Filter: Last Year</option>
//         </select>
//       </div>
